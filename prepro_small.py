...
def main():
    ...
    caption_file = 'data/annotations/first5000_data_train_final.json'

    image_dir = 'image/%2014_resized_small/'

    # about 80000 images and 400000 captions for train dataset
    train_dataset = _process_caption_data(caption_file='data/annotations/first5000_data_train_final.json',
                                          image_dir='image/train2014_resized_small/',
                                          max_length=max_length)

    # about 40000 images and 200000 captions
    val_dataset = _process_caption_data(caption_file='data/annotations/first1000_data_val_final.json',
                                        image_dir='image/val2014_resized_small/',
                                        max_length=max_length)
